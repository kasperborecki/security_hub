...
const AddGuardButton: React.FC<AddGuardButtonProps> = ({
  changeModalState
    ...
    return(
        <button
  className="rounded-lg relative w-56 h-8 cursor-pointer flex items-center border border-green-500 bg-green-500 group hover:bg-green-500 active:bg-green-500 active:border-green-500"
  onClick={changeModalState}
>
  <span
    className="text-[#ffffff] font-semibold ml-8 transform group-hover:translate-x-20 transition-all duration-200"
    >Dodaj Ochroniarza</span>
  <span
